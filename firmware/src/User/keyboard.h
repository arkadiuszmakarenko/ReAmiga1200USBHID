...
#define KEYCODE_TAB_SIZE 0x70

/* Timing constants (microseconds) */
#define TIMING_SYNC_DELAY_US        200
#define TIMING_HANDSHAKE_US         100
#define TIMING_BIT_DELAY_US         10
#define TIMING_CLOCK_PULSE_US       10
#define TIMING_DATA_SETUP_US        10
...
/* Public Functions */
void amikb_process_irq(void);
void amikb_init(void);
